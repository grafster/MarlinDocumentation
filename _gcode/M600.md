...
notes:
  - Requires `FILAMENT_CHANGE_FEATURE` or `ADVANCED_PAUSE_FEATURE`.
  - The settings for this command can be found in `Configuration.h` or `Configuration_adv.h`. At this time `M600` requires an LCD controller.
